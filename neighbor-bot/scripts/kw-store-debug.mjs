...
for(const url of ["https://smartstore.naver.com/01074323888/products/5251966721","https://m.smartstore.naver.com/01074323888/products/5251966721"]){
  ...
  console.log(`${url.slice(0,45)} → HTTP=${st} title="${title}" og="${og}"`);
}
await browser.close();
